...
<div class="row row-overflow">
    	<div class="col-xs-12 eqLogicThumbnailDisplay">
            ...
            <legend><i class="fas fa-table"></i> {{Mes températures ressenties}}</legend>
					...
					<div class="col-sm-6">
                        <form class="form-horizontal">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">{{Vitesse du Vent}}</label>
                                    <div class="col-md-6">
                                        <div class="input-group">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label help" data-help="{{Seuil de déclenchement de l'alerte inconfort de l'indice de température, 40°C par défaut (seuil de danger)}}">{{Seuil Humidex}}</label>
                                    <div class="col-md-6">
                                        <div class="input-group">
